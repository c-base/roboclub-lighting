	...
	return (function () {
		function t(e, n) {
			(function (e, t) {
				...
				m(this.element) &&
					p(this.element.rangeTouch) &&
					((this.config = r({}, i, {}, n)), this.init());
		}
		return (
			(n = t),
			(c = [
				{
					...
					value: function (e) {
						...
						if (
							(p(e) || d(e)
								? (o = Array.from(document.querySelectorAll(d(e) ? e : 'input[type="range"]')))
								: m(e)
								? (o = [e])
								: b(e)
								? (o = Array.from(e))
				...
				},
				{
					...
					value: function (e) {
						...
						var n,
							...
							u = parseFloat(r.getAttribute("min")) || 0,
							o = parseFloat(r.getAttribute("max")) || 100,
							c = parseFloat(r.getAttribute("step")) || 1,
							l = r.getBoundingClientRect(),
							a = ((100 / l.width) * (this.config.thumbWidth / 2)) / 100;
						return (
							0 > (n = (100 / l.width) * (i.clientX - l.left)) ? (n = 0) : 100 < n && (n = 100),
