...
!(function (t, n) {
	...
	function d(t, n, i) {
		...
		return (
			(o = n.key), null != (u = n.ref) && delete n.ref, null != o && delete n.key, c(t, n, o, u)
		);
	}
	function c(t, n, i, r) {
		var e = {
	...
	function e(t) {
		((!t.f && (t.f = !0) && 1 === s.push(t)) || i !== k.debounceRendering) &&
			((i = k.debounceRendering), (k.debounceRendering || n)(u));
	}
	function u() {
		var t, n, i, r, e, u, o, l;
		for (
	...
	function A(n, i, t, r, e, u, o, l, s) {
		var c,
			...
			y = p.length;
		if (
			(l == m && (l = null != u ? u[0] : y ? w(t, 0) : null),
			(c = 0),
			(i.n = S(i.n, function (t) {
				if (null != t) {
					if (
						((t.i = i),
						(t.e = i.e + 1),
						null === (h = p[c]) || (h && t.key == h.key && t.type === h.type))
					)
						p[c] = void 0;
					else
						for (f = 0; f < y; f++) {
					...
					if (
						((a = x(n, t, (h = h || m), r, e, u, o, null, l, s)),
						(f = t.ref) && h.ref != f && (g = g || []).push(f, t.c || a, t),
						null != a)
					) {
						if ((null == d && (d = a), null != t.l)) (a = t.l), (t.l = null);
							...
							t: if (null == l || l.parentNode !== n) n.appendChild(a);
								...
								for (v = l, f = 0; (v = v.nextSibling) && f < y; f += 2) if (v == a) break t;
								n.insertBefore(a, l);
							}
		...
		if (g) for (c = 0; c < g.length; c++) N(g[c], g[++c], g[++c]);
	}
	function S(t, n, i) {
		if ((null == i && (i = []), null == t || "boolean" == typeof t)) n && i.push(n(null));
		else if (Array.isArray(t)) for (var r = 0; r < t.length; r++) S(t[r], n, i);
		else
			i.push(
				n
					? n(
	...
	function h(t, n, i) {
		"-" === n[0]
			? t.setProperty(n, i)
			: (t[n] = "number" == typeof i && !1 === r.test(n) ? i + "px" : null == i ? "" : i);
	}
	function E(t, n, i, r, e) {
		var u, o, l, s, c;
		if (
			"key" === (n = e ? ("className" === n ? "class" : n) : "class" === n ? "className" : n) ||
			"children" === n
		);
		else if ("style" === n)
			if (((u = t.style), "string" == typeof i)) u.cssText = i;
				...
				if (i) for (l in i) (r && i[l] === r[l]) || h(u, l, i[l]);
			}
		else
			"o" === n[0] && "n" === n[1]
				? ((s = n !== (n = n.replace(/Capture$/, ""))),
				  ...
				  i
						? (r || t.addEventListener(n, a, s), ((t.t || (t.t = {}))[n] = i))
						: t.removeEventListener(n, a, s))
	...
	function x(t, n, i, r, e, u, o, l, s, c) {
		...
		try {
			t: if ("function" == typeof x) {
				if (
					((y = n.props),
					(b = (f = x.contextType) && r[f.c]),
					(w = f ? (b ? b.props.value : f.i) : r),
					i.c
						? (p = (h = n.c = i.c).i = h.m)
						: ("prototype" in x && x.prototype.render
								? (n.c = h = new x(y, w))
								: ((n.c = h = new O(y, w)), (h.constructor = x), (h.render = _)),
						  b && b.sub(h),
						  (h.props = y),
						  h.state || (h.state = {}),
						  (h.context = w),
						  ...
						  (a = h.f = !0),
						  (h.M = [])),
					null == h.j && (h.j = h.state),
					null != x.getDerivedStateFromProps &&
						j(h.j == h.state ? (h.j = j({}, h.j)) : h.j, x.getDerivedStateFromProps(y, h.j)),
					a)
				)
					null == x.getDerivedStateFromProps &&
						null != h.componentWillMount &&
						h.componentWillMount(),
						null != h.componentDidMount && o.push(h);
				else {
					if (
						(null == x.getDerivedStateFromProps &&
							null == l &&
							null != h.componentWillReceiveProps &&
							h.componentWillReceiveProps(y, w),
						!l && null != h.shouldComponentUpdate && !1 === h.shouldComponentUpdate(y, h.j, w))
					) {
						for (
							h.props = y,
								h.state = h.j,
								h.f = !1,
								(h.p = n).o = null != s ? (s !== i.o ? s : i.o) : null,
								n.n = i.n,
								f = 0;
							f < n.n.length;
							f++
				...
				for (
					v = h.props,
						...
						n.n = S(null != f && f.type == I && null == f.key ? f.props.children : f),
						null != h.getChildContext && (r = j(j({}, r), h.getChildContext())),
						a || null == h.getSnapshotBeforeUpdate || (g = h.getSnapshotBeforeUpdate(v, d)),
						A(t, n, i, r, e, u, o, s, c),
						h.base = n.o;
					(f = h.M.pop());

				)
					h.j && (h.state = h.j), f.call(h);
				a || null == v || null == h.componentDidUpdate || h.componentDidUpdate(v, d, g),
					p && (h.m = h.i = null);
			} else
				n.o = (function (t, n, i, r, e, u, o, l) {
					...
					return (
						null === n.type
							? a !== v && (null != u && (u[u.indexOf(t)] = null), (t.data = v))
							: n !== i &&
							  (null != u && (u = M.slice.call(t.childNodes)),
							  (f = (a = i.props || m).dangerouslySetInnerHTML),
							  (h = v.dangerouslySetInnerHTML),
							  l || ((h || f) && ((h && f && h.O == f.O) || (t.innerHTML = (h && h.O) || ""))),
							  (function (t, n, i, r, e) {
									var u;
							  ...
							  h || A(t, n, i, r, "foreignObject" !== n.type && e, u, o, m, l),
							  l ||
									("value" in v &&
										void 0 !== v.value &&
										v.value !== t.value &&
	...
	function R(t, n, i) {
		...
		if ((r = t.n)) for (u = 0; u < r.length; u++) r[u] && R(r[u], n, i);
		null != e && b(e);
	}
	function _(t, n, i) {
	...
	(k = {}),
		(O.prototype.setState = function (t, n) {
			...
			("function" == typeof t && !(t = t(i, this.props))) || j(i, t),
				null != t && this.p && ((this.u = !1), n && this.M.push(n), e(this));
		}),
		(O.prototype.forceUpdate = function (t) {
			this.p && (t && this.M.push(t), (this.u = !0), e(this));
		}),
		(O.prototype.render = I),
		(s = []),
		(n =
			"function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout),
		(i = k.debounceRendering),
		(k.o = function (t, n, i) {
			for (var r; (n = n.i); )
				if ((r = n.c) && !r.i)
					try {
			...
			return (
				(t.set = function (t) {
					if ("string" == typeof t)
						...
						t instanceof l
							? (this.hsv = t.hsv)
							: "object" == typeof t && "r" in t && "g" in t && "b" in t
							? (this.rgb = t)
							: "object" == typeof t && "h" in t && "s" in t && "v" in t
							? (this.hsv = t)
							: "object" == typeof t && "h" in t && "s" in t && "l" in t && (this.hsl = t);
					}
				}),
							...
							e < 66
								? ((n = 255),
								  (i =
										...
										104.49216199393888 * L(i)),
								  e < 20
										? 0
										: 0.8274096064007395 * (r = e - 10) -
										  254.76935184120902 +
										  115.67994401066147 * L(r))
								: ((n =
										351.97690566805693 +
										0.114206453784165 * (n = e - 55) -
										40.25366309332127 * L(n)),
								  (i =
										325.4494125711974 +
										0.07943456536662342 * (i = e - 50) -
										28.0852963507957 * L(i)),
								  255)),
						{ r: J(q(n), 0, 255), g: J(q(i), 0, 255), b: J(q(r), 0, 255) }
					);
				}),
					...
					},
					{
						...
						get: function () {
							var t = l.hsvToRgb(this.$),
								...
								i = t.g,
								r = t.b;
							return { r: U(n), g: U(i), b: U(r) };
						},
						set: function (t) {
							this.hsv = p({}, l.rgbToHsv(t), { a: void 0 === t.a ? 1 : t.a });
						},
					},
					{
						key: "rgba",
						get: function () {
							return p({}, this.rgb, { a: this.alpha });
						},
						set: function (t) {
							this.rgb = t;
						},
					},
					{
						...
						get: function () {
							var t = l.hsvToHsl(this.$),
								...
								i = t.s,
								r = t.l;
							return { h: U(n), s: U(i), l: U(r) };
						},
						set: function (t) {
							this.hsv = p({}, l.hslToHsv(t), { a: void 0 === t.a ? 1 : t.a });
						},
					},
					{
						key: "hsla",
						get: function () {
							return p({}, this.hsl, { a: this.alpha });
						},
						set: function (t) {
							this.hsl = t;
						},
						...
						set: function (t) {
							...
							if (
								((n = P.exec(t))
									...
									: (n = z.exec(t)) &&
									  ((i = K(n[1], 255)), (r = K(n[2], 255)), (e = K(n[3], 255)), (u = K(n[4], 1))),
								!n)
							)
						...
						set: function (t) {
							...
							if (
								((n = C.exec(t))
									...
									: (n = G.exec(t)) && ((i = Q(n[1])), (r = Q(n[2])), (e = Q(n[3])), (u = Q(n[4]))),
								!n)
							)
						...
						set: function (t) {
							...
							if (
								((n = H.exec(t))
									...
									: (n = $.exec(t)) &&
									  ((i = K(n[1], 360)), (r = K(n[2], 100)), (e = K(n[3], 100)), (u = K(n[4], 1))),
								!n)
							)
	...
	function it(t, n, i) {
		...
		return (
			(((n =
				(!i && "clockwise" === e) || (i && "anticlockwise" === e)
					? (i ? 180 : 360) - (r - n)
					: r + n) %
				360) +
				360) %
	...
	var st = ["mousemove", "touchmove", "mouseup", "touchend"],
		ct = (function (n) {
			...
			return (
				n && (t.__proto__ = n),
				(((t.prototype = Object.create(n && n.prototype)).constructor = t).prototype.render =
					function (t) {
						...
						return (
							...
							d(I, null, t.children(this.uid, i, u))
						);
					}),
	...
	function ft(t) {
		...
		return d(
			...
			{
				className:
					"IroHandle IroHandle--" + t.index + " " + (t.isActive ? "IroHandle--isActive" : ""),
				x: t.x,
				y: t.y,
				style: { overflow: "visible" },
			},
			i && d("use", Object.assign({ xlinkHref: ot(i) }, t.props)),
			!i && d("circle", { r: n, fill: "none", "stroke-width": 2, stroke: "#000" }),
			!i && d("circle", { r: n - 2, fill: t.fill, "stroke-width": 2, stroke: "#fff" })
		);
	}
	function ht(e) {
		var t = e.activeIndex,
			...
			c = (function (t, n) {
				...
				switch (t.sliderType) {
					...
					case "kelvin":
						for (
							var e = [], u = t.minTemperature, o = t.maxTemperature, l = o - u, s = u, c = 0;
							s < o;
							s += l / 8, c += 1
						) {
					...
					case "saturation":
						var d = Y.hsvToHsl({ h: i.h, s: 0, v: i.v }),
							g = Y.hsvToHsl({ h: i.h, s: 100, v: i.v });
						return [
							[0, "hsl(" + d.h + "," + d.s + "%," + d.l + "%)"],
							[100, "hsl(" + g.h + "," + g.s + "%," + g.l + "%)"],
						];
					case "value":
					default:
						var p = Y.hsvToHsl({ h: i.h, s: i.s, v: 100 });
						return [
							[0, "#000"],
							[100, "hsl(" + p.h + "," + p.s + "%," + p.l + "%)"],
						];
		...
		return d(
			...
			function (t, n, i) {
				return d(
					"svg",
					Object.assign({}, n, { className: "IroSlider", width: r, height: o, style: i }),
					d(
						"defs",
						null,
						d(
							...
							Object.assign(
								...
								(function (t) {
									...
									return { x1: "0%", y1: n ? "100%" : "0%", x2: n ? "0%" : "100%", y2: "0%" };
								})(e)
							),
							c.map(function (t) {
								return d("stop", { offset: t[0] + "%", "stop-color": t[1] });
							})
						),
						f &&
							d(
								"pattern",
								{ id: "b" + t, width: "8", height: "8", patternUnits: "userSpaceOnUse" },
								d("rect", { x: "0", y: "0", width: "8", height: "8", fill: "#fff" }),
								d("rect", { x: "0", y: "0", width: "4", height: "4", fill: "#ccc" }),
								d("rect", { x: "4", y: "4", width: "4", height: "4", fill: "#ccc" })
							),
						f &&
							d(
								"pattern",
								{ id: "f" + t, width: "100%", height: "100%" },
								d("rect", {
									x: "0",
									y: "0",
									width: "100%",
	...
	function at(e) {
		...
		return d(
			...
			Object.assign({}, e, {
				onInput: function (t, n, i) {
					if (0 === i) {
						...
						null !== r
							? s.setActiveColor(r)
							: ((s.inputActive = !0), (c.hsv = ut(e, t, n)), e.onInput(i, e.id));
			...
			function (t, n, i) {
				return d(
					"svg",
					Object.assign({}, n, { className: "IroBox", width: r, height: u, style: i }),
					d(
						"defs",
						null,
						d(
							"linearGradient",
							{ id: "s" + t, x1: "0%", y1: "0%", x2: "100%", y2: "0%" },
							f[0].map(function (t) {
								return d("stop", { offset: t[0] + "%", "stop-color": t[1] });
							})
						),
	...
	(ft.defaultProps = { fill: "none", x: 0, y: 0, r: 8, url: null, props: { x: 0, y: 0 } }),
		(ht.defaultProps = Object.assign(
			{},
			{ sliderShape: "bar", sliderType: "value", minTemperature: 2200, maxTemperature: 11e3 }
		));
	var vt = Array.apply(null, { length: 360 }).map(function (t, n) {
		return n;
	});
	function dt(e) {
		var t = nt(e),
		...
		return d(
			...
			Object.assign({}, e, {
				onInput: function (t, n, i) {
					if (0 === i) {
						...
						null !== r
							? f.setActiveColor(r)
							: ((f.inputActive = !0), (h.hsv = rt(e, t, n)), e.onInput(i, e.id));
			...
			function (t, n, i) {
				return d(
					"svg",
					Object.assign({}, n, { className: "IroWheel", width: r, height: r, style: i }),
					d(
						"defs",
						null,
						d(
							"radialGradient",
							{ id: t },
							d("stop", { offset: "0%", "stop-color": "#fff" }),
							d("stop", { offset: "100%", "stop-color": "#fff", "stop-opacity": "0" })
						)
					),
					d(
						"g",
						{ className: "IroWheelHue", "stroke-width": u, fill: "none" },
						vt.map(function (t) {
							return d("path", {
								key: t,
	...
	var gt = (function (i) {
		...
		return (
			i && (t.__proto__ = i),
			(((t.prototype = Object.create(i && i.prototype)).constructor = t).prototype.addColor =
				function (t, n) {
			...
			(t.prototype.onColorChange = function (t, n) {
				this.setState({ color: this.color }),
					this.inputActive && ((this.inputActive = !1), this.emit("input:change", t, n)),
			...
			(t.prototype.render = function (t, e) {
				...
				return (
					Array.isArray(n) ||
						((n = [{ component: dt }, { component: ht }]),
						e.transparency && n.push({ component: ht, options: { sliderType: "alpha" } })),
					d(
						"div",
						{ class: "IroColorPicker", id: e.id, style: { display: e.display } },
						n.map(function (t, n) {
							var i = t.component,
								r = t.options;
							return d(
	...
	var pt,
		...
		bt,
		wt,
		xt = ((kt.prototype = (pt = gt).prototype), Object.assign(kt, pt), (kt.A = pt), kt);
	function kt(n, t) {
		var i,
			...
			(function (t, n, i) {
				...
				k.i && k.i(t, n),
					...
					x(
						...
						i && !r ? [i] : e ? null : M.slice.call(n.childNodes),
						u,
						!1,
						i || m,
						r
